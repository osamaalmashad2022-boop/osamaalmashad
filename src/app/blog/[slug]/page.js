...
export default function BlogPostPage({ params }) {
  ...
  // Handle document title and description on mount / lang switch
  useEffect(() => {
    if (article) {
      document.title = `${article.title} | Osama Almashad`;
  ...
  const jsonLd = {
    ...
    "author": {
      "@type": "Person",
      "name": "Osama Almashad",
      "url": "https://osama-almashad.com"
    },
    "image": article.image ? `https://osama-almashad.com${article.image}` : undefined,
    "publisher": {
      "@type": "Person",
      "name": "Osama Almashad"
    },
  ...
  return (
    <div className="blog-page-container">
      ...
      {/* JSON-LD Schema Dynamic Injection */}
      <script
